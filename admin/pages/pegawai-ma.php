            ...
            <div class="box-body" style="min-height: 450px;">
              ...
              <table id = 'data_guru'>
                ...
                <tbody>
                  <?php 
                  $npsn = $_SESSION['npsn'];
                  $query = mysqli_query($conn, "SELECT tenkependik.*, profil.npsn, profil.nama_sekolah FROM tenkependik JOIN profil on tenkependik.npsn = profil.npsn WHERE profil.jenjang = 'SMA' OR profil.jenjang = 'MA' ");
                  $x = 1;
