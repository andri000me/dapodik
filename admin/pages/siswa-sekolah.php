            ...
            <div class="box-body" style="min-height: 450px;">
              <table id='siswa'>
                ...
                <tbody>
                  <?php 
                  $npsn = $_SESSION['npsn'];
                  $query = mysqli_query($conn, "SELECT * FROM siswa WHERE npsn = '$npsn'");
                  $x = 1;
                                ...
                                <div id="tambahmodal" class="modal fade" role="dialog">
                                  <div class="modal-dialog">
                                    ...
                                    <div class="modal-content">
                                      ...
                                      <form class="form-horizontal" action='pages/proses-tambah-siswa.php' method="POST" id="editform">
                                        <div class="form-group">
                                          <div class="col-sm-8">
                                            <input type="hidden" name="npsn" class="form-control" value="<?php echo "$npsn"; ?>">
                                          </div>
                                        </div>
                                        <div class="form-group">
                                          <label for="tahunajaran" class="col-sm-4 control-label" style="text-align: left;">Tahun Ajaran</label>
