  <?php
    ...
    include '../koneksi.php';    
    $npsn = $_GET['npsn'];
    $qsekolah = mysqli_query($conn, "SELECT nama_sekolah FROM profil WHERE npsn = $npsn");
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Guru
        <small><?php echo "$sekolah[nama_sekolah]"; ?></small>
      </h1>
    </section>
            ...
            <div class="box-body" style="min-height: 450px;">
              <table id='guru'>
                ...
                <tbody>
                  <?php  
                    $i = 1;
                    $query = mysqli_query($conn, "SELECT data_guru.* , profil.npsn, profil.nama_sekolah FROM data_guru JOIN profil ON data_guru.npsn = profil.npsn WHERE profil.npsn = '$npsn' ");
