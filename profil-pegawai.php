			...
			<div class="row content">
				<div class="col-md-12">
					<ol class="breadcrumb">
						...
						<?php echo "<li><a href='data-pegawai-kabupaten.php?id=$data[kab]'>" ?><?php echo "$ka[kabupaten]"; ?></a></li>
						...
						<div class="box-body">
							<div class="profile-content">
				                <table id="viewdatapegawai">
				                    ...
				                    <tbody>
				                    <?php 
				                        $qg =  mysqli_query($conn, "SELECT * FROM tenkependik WHERE npsn = '$npsn'");
				                        $x = 1;
				                        while ($vg = mysqli_fetch_array($qg, MYSQLI_BOTH)) {
				                            ...
				                            <tr>
					                            ...
					                            <td>"
					                ?>
					                            <?php echo "<a href='#' data-toggle='modal' data-target='#profil$x'>$vg[nama]</a>"; ?>
					                            ...
					                            <div id="profil<?php echo$x;?>" class="modal fade" role="dialog">
				                                  <div class="modal-dialog">
				                                    ...
				                                    <div class="modal-content">
				                                      ...
				                                      <?php  
				                                        $queryedit = mysqli_query($conn, "SELECT * FROM tenkependik WHERE nama = '$vg[nama]'");
