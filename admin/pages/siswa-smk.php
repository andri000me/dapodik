            ...
            <div class="box-body" style="min-height: 450px;">
              <table id='siswa'>
                ...
                <tbody>
                  <?php 
                  $npsn = $_SESSION['npsn'];
                  $query = mysqli_query($conn, "SELECT siswa.*, profil.npsn, profil.nama_sekolah FROM siswa JOIN profil ON profil.npsn = siswa.npsn WHERE profil.jenjang  = 'SMK' OR profil.jenjang = 'SLB' ");
                  $x = 1;
