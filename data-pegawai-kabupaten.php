	...
	<body class="landing">
			...
			<div class="row content">
				<div class="col-md-12 ">
					<ol class="breadcrumb">
						...
						<li><a href="data-pegawai.php">Pegawai</a></li>
						<?php echo "<li>"; echo "$ka[kabupaten]";; ?></li>
					</ol>
					<div class="box box-info">
						<div class="box-header">
							<h2 class="box-title"><b>Data Pegawai</b></h2>
						</div>
						<div class="box-body" style="overflow-x: scroll;">
							<table id='data-pegawai-kabupaten' class="table-responsive" >
								<thead>
									<tr>
								...
								<tbody>
									<?php 
										...
										while($kab = mysqli_fetch_array($query, MYSQLI_BOTH)){
											echo "<tr>
											<td>$x</td>
											<td style='min-width : 200px !important; text-align: left'><a href='profil-pegawai.php?npsn=$kab[npsn]'>$kab[nama_sekolah]</a></td>
											<td>$kab[jenjang]</td>
											";
											...
											$total = 0;
												...
												$q = mysqli_query($conn, "SELECT profil.kab, profil.jenjang, SUM(if(tenkependik.jk = 'L', 1, 0)) AS 'Laki', SUM(if(tenkependik.jk = 'P' , 1, 0)) AS 'Perempuan' FROM profil JOIN tenkependik ON profil.npsn = tenkependik.npsn WHERE profil.npsn = $kab[npsn]");

												$y = mysqli_fetch_array($q, MYSQLI_BOTH);

													$tot = $y['Laki'] + $y['Perempuan'];
													echo "<td>$y[Laki]</td><td>$y[Perempuan]</td><td><b>$tot</b></td>";
		...
		<!-- Scripts -->
			...
			<script type="text/javascript">
			  $(function(){
			    $('#data-pegawai-kabupaten').DataTable({
			      'paging' : true,
			      'searching' : true,
			      'info' : true
			    });
