        ...
        <section class="col-lg-12 connectedSortable">
          ...
          <div class="box box-info">
            <div class="box-header">
              <h3 class="box-title">Data Kepala Sekolah SMK dan SLB</h3>
            </div>
            <div class="box-body" style="min-height: 450px;">
              <table id='kepsek'>
                ...
                <tbody>
                  <?php  
                    $i = 1;
                    $query = mysqli_query($conn, "SELECT profil.*, kepsek.* FROM profil JOIN kepsek ON profil.npsn = kepsek.npsn WHERE profil.jenjang = 'SLB' OR profil.jenjang = 'SMK' ");
