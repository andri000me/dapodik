        ...
        <section class="col-lg-12 connectedSortable">
          ...
          <div class="box box-info">
            <div class="box-header">
              <h3 class="box-title">Data Sekolah SMA dan MA</h3>
            </div>
            <div class="box-body" style="min-height: 450px;">
              <table id='sekolah'>
                ...
                <tbody>
                  <?php  
                    $i = 1;
                    $query = mysqli_query($conn, "SELECT profil.* , kabupaten.kabupaten FROM profil JOIN kabupaten ON profil.kab = kabupaten.id WHERE jenjang = 'SMA' OR jenjang = 'MA' ");
