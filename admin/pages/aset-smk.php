  <?php
    ...
    $query = mysqli_query($conn, "SELECT profil.nama_sekolah, profil.npsn, COUNT(aset_tanah.id) AS jumlah_tanah FROM aset_tanah JOIN profil ON profil.npsn = aset_tanah.npsn JOIN kabupaten ON kabupaten.id = profil.kab WHERE profil.jenjang = 'SMK' OR profil.jenjang = 'SLB' GROUP BY profil.npsn ");
