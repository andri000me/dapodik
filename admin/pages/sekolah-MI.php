  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Sekolah
        <small>Madrasah Ibtidaiyah</small>
      </h1>
    </section>
        ...
        <section class="col-lg-12 connectedSortable">
          ...
          <div class="box box-info">
            <div class="box-header">
              <h3 class="box-title">Data Sekolah SD dan MI</h3>
            </div>
            <div class="box-body" style="min-height: 450px;">
              <table id='sekolah'>
                ...
                <tbody>
                  <?php  
                    $i = 1;
                    $query = mysqli_query($conn, "SELECT profil.* , kabupaten.kabupaten FROM profil JOIN kabupaten ON profil.kab = kabupaten.id WHERE jenjang = 'SD' OR jenjang = 'MI' ");
