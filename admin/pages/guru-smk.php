  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Guru
        <small>Sekolah Menengah Kejuruan dan Sekolah Luar Biasa</small>
      </h1>
    </section>
        ...
        <section class="col-lg-12 connectedSortable">
          ...
          <div class="box box-info">
            <div class="box-header">
              <h3 class="box-title">Data Sekolah SMK dan SLB</h3>
            </div>
            <div class="box-body" style="min-height: 450px;">
              <table id='guru'>
                ...
                <tbody>
                  <?php  
                    $i = 1;
                    $query = mysqli_query($conn, "SELECT data_guru.* , profil.npsn, profil.nama_sekolah FROM data_guru JOIN profil ON data_guru.npsn = profil.npsn WHERE profil.jenjang = 'SMK' OR profil.jenjang = 'SLB' ");
