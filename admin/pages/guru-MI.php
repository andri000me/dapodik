        ...
        <section class="col-lg-12 connectedSortable">
          ...
          <div class="box box-info">
            <div class="box-header">
              <h3 class="box-title">Data Guru SD dan MI</h3>
            </div>
            <div class="box-body" style="min-height: 450px;">
              <table id='guru'>
                ...
                <tbody>
                  <?php  
                    $i = 1;
                    $query = mysqli_query($conn, "SELECT data_guru.* , profil.npsn, profil.nama_sekolah FROM data_guru JOIN profil ON data_guru.npsn = profil.npsn WHERE profil.jenjang = 'MI' OR profil.jenjang = 'SD' ");
